        ...
        <div className="space-y-4">
          ...
          {rateLimitInfo && rateLimitInfo.remaining > 0 && (
            <div className="text-xs text-slate-500 text-center">
              ...
              {rateLimitInfo.remaining === 1 ? "post" : "posts"} remaining today
            </div>
          )}
        </div>
      </div>
